...
| Ticker | Name | Notes |
|---|---|---|
| SMH | VanEck Semiconductor ETF | Original pick |
| SOXX | iShares Semiconductor ETF | Overlaps SMH — pick one, not both |

## Memory
| Ticker | Name | Notes |
|---|---|---|
| DRAM | Roundhill Memory ETF | Original pick |

## Cybersecurity
| Ticker | Name | Notes |
|---|---|---|
| CIBR | First Trust Nasdaq Cybersecurity ETF | Original pick |

## Cloud / AI software
| Ticker | Name | Notes |
|---|---|---|
| SKYY | First Trust Cloud Computing ETF | |
| AIQ | Global X Artificial Intelligence & Technology ETF | Software/services side, not just hardware |
...
| NLR | VanEck Uranium and Nuclear ETF | Data-center power-demand driver |

## Materials / physical buildout
| Ticker | Name | Notes |
|---|---|---|
